...
Constellation = pd.read_excel(open('Input/Inputs__Zpos_0_82.xlsx','rb'), index=False)
...
cols                    =       ['Sx', 'Sy', 'Sz', 'Rx', 'Ry', 'Rz', 'Ax', 'Ay', 'Az', 'PSpectroFlat', 'SSpectroFlat', 'ANCRed']
data                    =       pd.DataFrame(result, columns = cols)
writer                  =       ExcelWriter('Results/Results__Zpos_0.82_UnClustered.xlsx')
